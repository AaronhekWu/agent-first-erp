...
export function CourseList({ courses, departments, page, pageSize, emptyMessage, selectedCourseId, sort }: { courses: CourseRow[]; departments: Department[]; page: number; pageSize: number; emptyMessage: string; selectedCourseId?: string; sort: CourseSort }) {
